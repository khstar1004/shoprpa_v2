...
/**
 * @param key 로Code.Component및componentId연결그룹성공, 예: Code.Component.1960590437807538176
 */
...
export async function getComponentForm(params: {
  ...
  const mainProcessId = processList.find(item => item.name === '프로세스')?.resourceId
