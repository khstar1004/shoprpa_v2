...
export const BROWER_PLUGIN_LIST: PLUGIN_ITEM[] = [
  {
    type: BROWER_LIST.CHROME, // chrome프로그램
    icon: googleIcon,
    title: 'chrome',
    isInstall: false,
    installVersion: '',
  ...
  {
    type: BROWER_LIST.EDGE, // edge프로그램
    icon: edgeIcon,
    title: 'edge',
    isInstall: false,
    installVersion: '',
  ...
  {
    type: BROWER_LIST.FIREFOX, // firefox프로그램
    icon: firefoxIcon,
    title: 'firefox',
    isInstall: false,
    installVersion: '',
  ...
  {
    type: BROWER_LIST['360SE'], // 360프로그램
    icon: safe360Icon,
    title: '360',
    isInstall: false,
    installVersion: '',
  ...
  {
    type: BROWER_LIST['360X'], // 360x프로그램
    icon: x360Icon,
    title: '360x',
    isInstall: false,
    installVersion: '',
