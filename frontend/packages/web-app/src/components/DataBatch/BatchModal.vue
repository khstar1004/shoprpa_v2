...
<template>
  ...
  >
    <div class="batch-modal">
      ...
      <!-- 열선택 type colFilterConfig, 패키지일개AND /OR 의radio, 및다중개파일1, 2, 3 매개파일있음대기대기기호 -->
      ...
      <!-- 테이블선택 type filterConfig, 패키지일개AND /OR 의radio, 및다중개파일1, 2, 3 매개파일있음대기대기기호 -->
