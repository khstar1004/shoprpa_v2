...
const gridOptions: VxeGridProps<RPA.ConfigParamData> = {
 ...
 columns: [
 { field: 'varName', title: '변수명', slots: { default: 'name_default' } },
 { field: 'varDirection', title: '입력/출력', slots: { default: 'usage_default' } },
 { field: 'varType', title: '유형', slots: { default: 'type_default' } },
 { field: 'varDescribe', title: '', slots: { default: 'desc_default' } },
 ],
}
