...
<template>
 ...
 <!-- <rpa-hint-icon :name="sidebarWide ? 'sidebar-wide' : 'sidebar-narrow'" :title="sidebarWide ? '자르기교체까지버전' : '자르기교체까지너비버전'" class="ml-[12px]" enable-hover-bg width="16px" height="16px" @click="() => sidebarWide = !sidebarWide" /> -->
 </div>
