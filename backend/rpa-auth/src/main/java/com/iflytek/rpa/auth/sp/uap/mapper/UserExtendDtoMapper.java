...
/**
 * UserExtendDto 기기
 * 에서 core 의 UserExtendDto 및 UAP 클라이언트의 UserExtendDto 변환
 *
 * 패키지유형 TenantModeExtendDto 으로속성구성원: 
 * - user: UapUser <-> User(복사사용 UserMapper)
...
public class UserExtendDtoMapper {
    ...
    /**
     * UAP -> core 의 UserExtendDto 변환
     *
     * @param uapUserExtendDto UAP 의 UserExtendDto
     * @return core 의 UserExtendDto
     */
    public UserExtendDto fromUapUserExtendDto(com.iflytek.sec.uap.client.core.dto.user.UserExtendDto uapUserExtendDto) {
        ...
        // roles 필드: List<RoleBaseDto> (UAP) -> List<RoleBaseDto> (core)
    ...
    /**
     * core -> UAP 의 UserExtendDto 변환
     *
     * @param userExtendDto core 의 UserExtendDto
     * @return UAP 의 UserExtendDto
     */
    public com.iflytek.sec.uap.client.core.dto.user.UserExtendDto toUapUserExtendDto(UserExtendDto userExtendDto) {
        ...
        // user 필드: User -> UapUser(통신경과 BeanUtils 단일복사)
        ...
        // extands 필드: List<UapExtendRelation> (core) -> List<UapExtendRelation> (UAP)
        ...
        // roles 필드: List<RoleBaseDto> (core) -> List<RoleBaseDto> (UAP)
    ...
    /**
     * UAP 의 UapExtendRelation -> core 의 UapExtendRelation
     */
    private UapExtendRelation fromUapExtendRelation(
        ...
        // 패키지유형 UapExtand 및 TenantModeExtendDto 의필드
        BeanUtils.copyProperties(uapExtendRelation, coreRelation);
        return coreRelation;
    }

    /**
     * core 의 UapExtendRelation -> UAP 의 UapExtendRelation
     */
    ...
    /**
     * UAP 의 RoleBaseDto -> core 의 RoleBaseDto
     */
    ...
    /**
     * core 의 RoleBaseDto -> UAP 의 RoleBaseDto
     */
