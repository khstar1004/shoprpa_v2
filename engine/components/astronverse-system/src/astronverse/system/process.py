...
class Process:
    ...
    def run_command(
        ...
        try:
            ...
            raise BaseException(CMD_ERROR_FORMAT.format(command, e), "CMD명령실행실패")
        return True
    ...
    def terminate_process(
        ...
        if termination_type == TerminationType.PID:
            if isinstance(pid, list):
                ...
                raise NotImplementedError("입력PID값오류, 확인하세요입력유형")
