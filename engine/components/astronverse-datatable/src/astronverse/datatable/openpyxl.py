...
class OpenpyxlWrapper:
    ...
    def save(self, path: str = None):
        ...
        try:
            ...
            raise DATAFRAME_EXPECTION(WRITE_PERMISSION_DENIED_ERROR_FORMAT.format(save_path), "입력Excel파일실패")
        except Exception as e:
            raise DATAFRAME_EXPECTION(WRITE_DATA_ERROR_FORMAT.format(save_path, str(e)), "입력Excel파일실패")
