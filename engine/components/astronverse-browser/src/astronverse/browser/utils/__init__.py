...
BROWSER_OPEN_TIMEOUT: ErrorCode = ErrorCode(BizCode.LocalErr, _("브라우저 열기시간 초과"))
...
CODE_NO_MAIN_FUNC: ErrorCode = ErrorCode(BizCode.LocalErr, _("코드중패키지main데이터"))
FOCUS_TIMEOUT_MUST_BE_POSITIVE: ErrorCode = ErrorCode(BizCode.LocalErr, _("시간 초과시간대0"))
KEY_PRESS_INTERVAL_MUST_BE_NON_NEGATIVE: ErrorCode = ErrorCode(BizCode.LocalErr, _("입력대대기0"))

LINUX_MUST_BROWSER_PATH_ERROR: ErrorCode = ErrorCode(BizCode.LocalErr, _("Linux입력브라우저주소"))