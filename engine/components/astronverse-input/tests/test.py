...
class TestKeyboard(TestCase):
    def test_input(self):
        gui = Gui()
        # gui.keyboard(keyboard_type = KeyboardType.NORMAL, message="&#   ￥W……&￥#……#￥%행및공백", simulate_flag=Simulate_flag.YES, interval=0.1)
        # gui.keyboard(keyboard_type = KeyboardType.NORMAL, message="change가져오기중국어내용", simulate_flag=Simulate_flag.NO, interval=0.5)
