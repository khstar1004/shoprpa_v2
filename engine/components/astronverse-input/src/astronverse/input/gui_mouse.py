...
class GuiMouse:
    ...
    def mouse(
        ...
        """
        마우스클릭
        :param btn_type: 마우스유형   LEFT:왼쪽 버튼, RIGHT:오른쪽 버튼, MIDDLE:중
        :param btn_model: 마우스 이동 방식  Click:단일, DoubleClick:더블클릭, Down:아래, Up:열기
        :param ctrl_type: 유형  없음/Ctrl/Alt/Shift/Win/Shape
        """
        # 아래
    ...
    def mouse_wheel(
        ...
        """
        마우스
        :param scroll_type: 유형  데이터/이미지
        :param times: 데이터
        :param scroll_px: 이미지
        :param direction: 방법      위/아래
        :param ctrl_type: 유형  없음/Ctrl/Alt/Shift/Win/Shape
        """
    ...
    def mouse_move(
        ...
        """
        :param window_type: 창유형  전체/창
        :param window_position: 창왼쪽위역할
        :param position_x: 종료위치x
        :param position_y: 종료위치y
        :param move_speed: 정도    높이/중/낮음
        :param move_type: 방식     LINEAR:, SIMULATION:, TELEPORTATION:
        """
    ...
    def mouse_drag(
        ...
        """
        마우스
        :param start_pos_x: 위치x
        :param start_pos_y: 위치y
        :param end_pos_x: 결과위치x
        :param end_pos_y: 결과위치y
        :param btn_type: 유형        LEFT:왼쪽 버튼, RIGHT:오른쪽 버튼, MIDDLE:중
        :param move_type: 유형       LINEAR:, SIMULATION:, TELEPORTATION:
        :param move_speed: 정도      높이/중/낮음
        :param ctrl_type: 키보드   없음/Ctrl/Alt/Shift/Win/Shape
