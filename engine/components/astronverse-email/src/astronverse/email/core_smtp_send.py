...
class EmailSmtpSend:
    ...
    def __handle_email_address__(address_list):
        ...
        # address_list예설치완료기존본입력str의list ["a@qq.com;b@qq.com","a@163.com]
        # address_group_list예설치에서완료분분열기후의list의list [["a@qq,com","b@qq.com"],["a@163.com"]]
        return address_list, address_group_list

    @staticmethod
    def __handle_attachment__(attachment_path):
        """
        추가파일. 후필요추가다중개파일, 가능으로외부모듈호출방법법.
        """
    ...
    def send(
        ...
        for i in range(len(receiver_list)):
            ...
            msg["Subject"] = subject or "{}의메일".format(user)
            ...
            try:
                ...
                raise BaseException(LOGIN_FAIL_FORMAT.format(e), "전송실패{}".format(e))