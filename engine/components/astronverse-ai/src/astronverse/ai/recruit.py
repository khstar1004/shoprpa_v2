...
class RecruitAI:
    ...
    keywords_boss = {
        ...
        "경력요건": ["제한 없음", "재학생/신입", "1-3년", "3-5년", "5-10년", "10년 이상"],
        "연령요건": [
            "제한 없음",
            "20-25",
            "25-30",
    ...
    keywords_zhilian = {
        "학력요건": ["제한 없음", "전문대 이상", "학사 이상", "석사 이상", "직접 입력"],
        "연령요건": ["제한 없음", "20-25", "25-30", "30-35", "35-40", "40 이상", "직접 입력"],
        "경력요건": ["제한 없음", "", "1-3년", "3-5년", "5-10년", "직접 입력"],
        "학교요건": ["제한 없음", "정규 대학", "985 대학", "211 대학", "일반 대학", "해외 대학"],
    }
