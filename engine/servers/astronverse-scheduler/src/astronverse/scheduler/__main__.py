...
def main():
    ...
    parser.add_argument("--conf", type=str, default="../resources/conf.yaml", help="매칭파일")
    parser.add_argument("--venv", type=str, help="매칭파일")
    parser.add_argument("--stop", type=bool, default=False, help="닫기서비스")
