# 🤖 Shoprpa Frequently Asked Questions (FAQ)
...
**A:** ❌ **Not yet!** The open-source version of Shoprpa client currently only supports Windows systems.
...
It is recommended to download the official stable installation package (e.g., v1.1.2+) directly from the [Release page](https://github.com/shoprpa/shoprpa/releases).
...
**A:** ✅ **No!** You can download the msi installer package directly from the [Release version](https://github.com/shoprpa/shoprpa/releases) and install it directly.
...
docker rmi ghcr.io/shoprpa/shoprpa/openapi-service:latest
docker rmi ghcr.io/shoprpa/shoprpa/ai-service:latest
docker rmi ghcr.io/shoprpa/shoprpa/robot-service:latest
...
# services:
#   openapi-service:
#     # image: ghcr.io/shoprpa/shoprpa/openapi-service:latest
#     build:
#       context: ..
...
# From: \shoprpa\engine\shared\astronverse-workflowlib\src\astronverse\workflowlib
# To: C:\Program Files\Shoprpa\data\python_core\Lib\site-packages\astronverse\workflowlib
```
...
For more web automation information, see the [Official Guide](https://www.shoprpa.com/docs/quick-start/web-automation.html)
...
For external calls, the official [documentation](https://www.shoprpa.com/docs/open-api/overview.html) has detailed descriptions and API documentation.

The only thing to note is that all URLs need to be changed from the official domain to your own server domain.

```bash
# Official version:
https://newapi.shoprpa.com/api/rpa-openapi/workflows/get
...
### Q: 🆕 Can Shoprpa add comments in sub-workflows?
...
# If software is installed on C drive: %APPDATA%\shoprpa\logs
```
...
|------|------|---------|
| 🐙 GitHub Issues | [Submit Issue](https://github.com/shoprpa/shoprpa/issues) | 24-48 hours |
| 💬 Discussions | [Discussion Forum](https://github.com/shoprpa/shoprpa/discussions) | Within a week |

### 📚 Useful Resources

- 🏠 [Project Homepage](https://github.com/shoprpa/shoprpa)
- 📖 [Project Introduction](./README.md)
- 📝 [Complete Installation Guide](./BUILD_GUIDE.md)
- 🐳 [Docker Deployment Guide](./docker/QUICK_START.md)
- 👨‍💻 [Usage Guide](https://www.shoprpa.com/docs)
